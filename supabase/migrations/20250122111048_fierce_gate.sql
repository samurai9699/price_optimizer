...
BEGIN
  ...
  DROP POLICY IF EXISTS "Users can view competitor prices for their products" ON competitor_prices;
  DROP POLICY IF EXISTS "Users can manage competitor prices for their products" ON competitor_prices;
  DROP POLICY IF EXISTS "Users can view recommendations for their products" ON price_recommendations;
  DROP POLICY IF EXISTS "Users can manage recommendations for their products" ON price_recommendations;
